          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Video Club</span></h5>
                <ol class="breadcrumbs mb-0">
                  <li class="breadcrumb-item"><a href="<?php echo base_url() ; ?>">Accueil</a>
                  </li>
                  <li class="breadcrumb-item"><a href="<?php echo base_url() ; ?>">Liste des Films</a>
                  </li>
                  <li class="breadcrumb-item"><a href="<?php echo base_url() ; ?>">Genres</a>
                  </li>
  ...
  <div id="image-card" class="section">
    <br><br><br>
    <h4 class="header">Liste des films</h4>
    ...
    <?php if (isset($tabFilm)) {  ?>
          ...
          //$genres = $genresModel->where('code',$film['genre'])->first();
      ...
      <div class="col s12 m4">
        <div class="card gradient-45deg-light-blue-cyan">
          <div class="card-content white-text center">
            <h6 class="card-title font-weight-400"><?php echo $film['titre'] ; ?></h6>

            <img src="/imagesmin/1615315969_3e3555336e685569cfa9.jpg" >
            ...
            <br><br>
            <a href="<?php echo base_url('home/index/genre/'.$film['genre']) ; ?>"><?php echo "Genre : ".$film['genre'] ; ?></a>
            <br><br>
            <a href="<?php echo base_url('home/index/pays/'.$film['code_pays']) ; ?>"><?php echo "Pays : ".$film['code_pays'] ; ?></a>
          </div>
